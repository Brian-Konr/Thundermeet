...
export default function LoginCard() {
  ...
  return(
    <Card style={{marginTop: '2vh', width: '30vw', 'minHeight': '40vh', display: 'flex', justifyContent: 'center', borderRadius: '1.6vw', boxShadow: '2px 2px gray'}}>
      <Form
        name="login"
      ...
      <div style={{textAlign: 'center', fontSize: '16px', marginTop: '1vh'}}>Or <a href="">register now!</a></div>
    </Card>
  )
}